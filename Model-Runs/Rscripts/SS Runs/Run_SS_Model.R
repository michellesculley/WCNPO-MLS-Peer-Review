...
model.info<-list(
  ...
  "scenario"="2019_Growth",  ## refers to the tab in CTL_inputs, I recommend making a new tab for each structural change when running sensitivity analyses
  "binwidth"=5,
  "bin.min"=50,
  "bin.max"=230,
