...
model.info<-list(
  ...
  "Nsurvey"=6,
  "Nsexes" = 1,
  "inF_fleet" = 4, # fleet numbers of the fleet(s) with intial equilibrium catch
  "Species"="MLS",
  "fleets"=fleetnames,
  "catch.file"="InputCatch_Base.csv",
  "length.file"="InputLength_Base.csv",
  "CPUE.file"="InputCPUE_Base.csv",
  "scenario"="base",  ## refers to the tab in CTL_inputs, I recommend making a new tab for each structural change when running sensitivity analyses
  "binwidth"=5,
  "bin.min"=50,
  "bin.max"=230,
